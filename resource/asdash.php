...
<div class="row bg-warning pad1 margin1 border2 shadow-lg">
		...
		<a href="asdash.php" class="btn text-white bg-success border3">Document Requests</a>
		</div>
		<div class="col-9 text-right" style="margin-top:5px; margin-bottom:5px">
...
<div class="row margin1">
		<div class="col-4">
			<div class="card" style="margin: 8px -10px 10px 0px; border: solid black 1px;">
				...
				<form method="post" action="asdash.php">
...
<script type="text/javascript">
	...
	function claimedAlert(id){
		window.location.href='asdash.php?claimid='+id;
		alert("Moved to Archive");
	}
	function deleteDoc(id){
		if(confirm("Delete Record?")){
			window.location.href='asdash.php?delid='+id;
			return true;
		}
	}
	function notifyUser(id){
		window.location.href='asdash.php?notifyid='+id;
